...
const persons = [
  {
    name: 'Syed Anas Tanweer',
    role: 'Full Stack Developer',
    avatar: 'https://avatars.githubusercontent.com/u/109587406?v=4',
    github: 'https://github.com/syedanastanweer',
    linkedin: 'https://www.linkedin.com/in/syedanastanweer/',
  },
];
