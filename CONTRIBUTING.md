...
## Where to start
View [issues tagged with the *Good First Issues* label](https://github.com/syedanastanweer/resume-builder/labels/good%20first%20issue) to find good first feature requests and bugs to fix.

Visit https://github.com/syedanastanweer/resume-builder/issues to view all issues.
...
TODO(sadanandpai): Per issue https://github.com/syedanastanweer/resume-builder/issues/175, add instructions for how to create a template.
